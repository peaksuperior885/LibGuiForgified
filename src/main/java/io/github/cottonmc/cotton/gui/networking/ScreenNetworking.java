 ...
 * <pre>
 * {@code
 * private static final ResourceLocation MESSAGE_ID = ResourceLocation.fromNamespaceAndPath("my_mod", "some_message");
 *
 * // Receiver
...
public interface ScreenNetworking {
	 ...
	 * @throws NullPointerException  if either parameter is null
	 */
	void receive(ResourceLocation message, MessageReceiver receiver); // Identifier -> ResourceLocation
	 ...
	 * @throws NullPointerException if either parameter is null
	 */
	void send(ResourceLocation message, Consumer<FriendlyByteBuf> writer); // Identifier -> ResourceLocation, PacketByteBuf -> FriendlyByteBuf
	...
	interface MessageReceiver {
		 ...
		 */
		void onMessage(FriendlyByteBuf buf); // PacketByteBuf -> FriendlyByteBuf
	}
}
